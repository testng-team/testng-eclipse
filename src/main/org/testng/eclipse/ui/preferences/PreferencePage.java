...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
  ...
  private void createReportersFieldEditor(Composite parent) {
    ...
    m_reporters= new StringFieldEditor(TestNGPluginConstants.S_REPORTERS, "Listeners/Reporters (separated by space or ;)", StringFieldEditor.UNLIMITED, composite) { //$NON-NLS-1$
